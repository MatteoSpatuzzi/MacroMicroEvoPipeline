...
WorkingDirectory = "scripts/pipeline_files/functions"
...
# info
classification_sqm <- read.csv("classification_tab.csv")
...
gene_mat <- cbind(gene_mat, Find_gene_loci(Phy_dat_sqm, GenBank_matrix_sqm))
...
setwd(WorkingDirectory)
setwd("MAlign")
MAFFT_run(sequ = "MAlign_fasta", new_sequ = "Trial_py" , filewise = TRUE)
